    ...
    return (
        <div>
            ...
            <div className='signup' >
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    ...
                                    <input type="text" id="username" name="username" required placeholder="Username" onChange={handleChangeUser}/>
                                </td>
                                <td>
                                    <label>Fullname</label><br/>
                                    <input type="text" id="fullname" name="fullname" required placeholder="Fullname" onChange={handleChangeFull}/>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" id="address" name="address" required placeholder="Ho Chi Minh" onChange={handleChangeAddress}/>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label>Password</label><br/>
                                    <input type="password" id="password" name="password" required placeholder="Password" onChange={handleChangePass}/>
                                </td>
                                <td>
                                    <label>Confirm password</label><br/>
                                    <input type="password" id="confirm" name="confirm" required placeholder="Password" onChange={handleChangeConfirm}/>
                                </td>
                            </tr>
                        </tbody>
                    </Table>
                ...
                <div>
                    <a href='login' className='already-member'>Already have account?</a>
                </div>
            </div>
        </div>
    );

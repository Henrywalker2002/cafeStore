...
function MenuList() {
  ...
  var trls = testList.map((element) => {
    var thname = createElement(
      "td",
      { className: "menu-list-td" },
      element.name
    );
    var thprice = createElement(
      "td",
      { className: "menu-list-td" },
      element.price
    );
    ...
    var tr = createElement("tr", { className: [element.id, "menu-list-tr"] }, [
      thimage,
      thname,
      thprice,
      delBtn,
  ...
  return (
    <div className="menu-list">
      ...
      <div className="searchBar">
        ...
        <button className="addItem-btn" onClick={handleAddForm}>
          + Add Item
        </button>
      </div>
      <table class="menu-table">
        <thead className="menu-list-thead">
          <th className="menu-list-th">IMAGE</th>
          <th className="menu-list-th">NAME</th>
          <th className="menu-list-th">PRICE</th>
          <th></th>
        </thead>
        <tbody className="menu-list-tbody">
          ...
          {showForm && (
            <tr className="menu-list-tr add-form">
              ...
              <td className="menu-list-td">
                <button type="submit" className="addBtn" onClick={addDrink}>
                  Add
                </button>
              </td>
            </tr>
      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent>
          <DialogContentText>Fill information change</DialogContentText>
